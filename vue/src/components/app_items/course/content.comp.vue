<template>
  <div class="container">
    ...
    <div class="main" v-else v-show="!isChildActived()">
      ...
      <div id="comments" v-if="showComment" class="comments block">
        <h2>评论</h2>
      ...
      <footer class="tool-bar" v-if="showComment" v-show="!(isVideoPlayed && isLandscape)" ref="toolBar"
  ...
  export default class ContentComponent extends Vue {
    ...
    async initData() {
      ...
      try {
        ...
        console.log(this.itemInfo.current.currentUserInfo);
