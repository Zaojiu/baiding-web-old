...
<script lang="ts">
  ...
  export default class ActivateComponent extends Vue {
    ...
    changeNav(navIndex: number) {
      switch (navIndex) {
        case 0:
          this.$router.push({path: `/wv/ios-member/card`});
          break;
        case 1:
          this.$router.push({path: '/wv/ios-member/action'});
          break;
        case 2:
          this.$router.push({path: '/wv/ios-member/video'});
          break;
        case 3:
          this.$router.push({path: '/wv/ios-member/course'});
          break;
        case 4:
          this.$router.push({path: '/wv/ios-member/download'});
          break;
        default:
      }
    }
