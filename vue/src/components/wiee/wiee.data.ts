...
export const guests = [
  ...
  },
  {
    ...
    enName: 'Xin Rong',
    desc: ['中欧国际工商学院管理学教授、副教务长 (欧洲事务)、中国企业全球化中心联合主任'],
    enDesc: ['Professor of Management, Deputy Registrar of European Affairs of China Europe International Business School, co-director of China Enterprise Globalization Centre'],
    url: 'https://og9s6vxbs.qnssl.com/wiee/guestsqirong_b.jpg',
    cover: 'https://og9s6vxbs.qnssl.com/wiee/guestsqirong_s.jpg'
  },
  {
...
export const PlanList = [
  ...
  {
    title: '5.20',
    desc: ['区块链经济论坛', '同济·MIT 城市科学峰会 2018'],
    content: [
      {
        start: '09:30',
        end: '09:35',
      ...
      },
      {
        ...
        title: [
          'Token经济三人谈：冒志鸿、张一甲、王建硕'
        ],
        desc: '冒志鸿：ArcBlock创始人兼CEO； \n' +
        '王建硕：百姓网创始人兼CEO；\n' +
        '张一甲：甲子光年创始人兼CEO；\n',
        status: 1
      },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        desc: '金贝塔网络金融科技CEO，前嘉实基金副总经理，首席投资官',
        status: 1
      },
      {
        start: '11:00',
...
export const enPlanList = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        desc: 'Guest moderator, Innovation Director, correspondent and news commentator of DRAGON TV',
        status: 1
      }
    ]
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        desc: 'Founder of Lightneer, Co-founder of Angry Birds and SLUSH',
        status: 1
      },
      {
        start: '14:25',
      ...
      },
      {
        ...
        desc: 'Member of Chang Jiang Scholars Program, former Dean of the School of Design, Central Academy of Fine Arts',
        status: 1
      },
      {
        start: '15:40',
      ...
      },
      {
        ...
        desc: 'Executive Vice-Dean of School of Enterpreneurship and Innovation, Tongji University',
        status: 1
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        desc: 'Photographer of National Geographic Magazine ',
        status: 1
      },
      {
        start: '16:30',
