  ...
  >
    ...
    >
      ...
      <div id="enter" class="enter">
        ...
        <p>
          一、“博览会”园区将在上午8:30分开放入场，20:00时停止入场，所有人员进入场馆前必须经过安全检查，为确保观众准时入场观看比赛，请充分考虑交通与安检排队所需时间，尽可能选择公共交通，提早抵达场馆。
        </p>
        <p>
        ...
        <p>
          四、为了他人能够愉悦地参观园区，以下行为在场馆中将被视作不当行为并予以制止：在非吸烟区吸烟；翻越护栏、踩踏座椅；携带婴儿车或轮椅进入非无障碍坐席；进入贵宾区、工作区等非参观区域；在坐席区内撑伞、长时间站立等遮挡他人视线或影响他人观赛的行为；刻意展示、宣传服饰及随身物品上的商业标识；集体穿戴含有相同或相似设计图案、色彩组合或商业标志的服饰；其它分散参观人员注意力，影响创博会顺利进行或妨碍他人参观的行为，包括明显处于醉酒状态进入场馆，不服从工作人员管理等。
        </p>
        <p>
